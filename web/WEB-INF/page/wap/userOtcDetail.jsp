...
<head>
    ...
    <link rel="stylesheet" href="<%=path %>/resources/css/wap/offline-transaction-detail.css">
...
<main>
    ...
    <div class="item-dealer-info">
        ...
        <div class="item-inner">
            <div>经销商名称</div>
            <div>${otcTransactionUserDeal.dealerName}</div>
        </div>
        <div class="item-inner">
            <div>手机号</div>
            <div>${otcTransactionUserDeal.phoneNumber}</div>
        </div>
    </div>
    </c:if>
    ...
    <c:if test="${otcTransactionUserDeal.dealType == 1}" >
        <c:if test="${otcTransactionUserDeal.paymentType == 1}" >
            <!--银行支付 -->
            <div class="item-dealer-info-bank">
                <div class="item-title">
                    经销商信息
                </div>
                <div class="item-inner">
    ...
    <div class="item-time">
        ...
        <div class="item-inner">
            ...
            <p class="button" onclick="confirmReceipt('${otcTransactionUserDeal.otcOrderNo}')">确认收款</p>
            </c:if>
            </c:if>
