    ...
    <div class="content">
        ...
        <ul>
            <c:forEach items="${systemHotList}" var="item">
                <a href="<%=path %>/userWap/wapSystemHot/showHotDetail/${item.id}" class="notice" >
                    <li>
                        ...
                        <div class="noticeInfo list-box">
                            <p class="noticeTitle title">【<span>话题</span>】${item.noticeTitle}</p>
...
<script src="<%=path %>/resources/js/wap/hot.js"></script>
