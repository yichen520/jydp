    ...
    <div class="contentRight">
        ...
        <div class="top">
            ...
            <form id="queryForm" action="<%=path%>/backerWeb/hotTopic/show.htm" method="post">
                <div class="askArea">
                    <p class="condition">话题类型：<input type="text" class="askInput" id="query_noticeType" name="noticeType" value="${noticeType }" maxLength="16"/></p>
                    <p class="condition">话题标题：<input type="text" class="askInput"  id="query_noticeTitle" name="noticeTitle" value="${noticeTitle }" maxLength="32"/></p>
            ...
            <table class="table" cellpadding="0" cellspacing="0">
                ...
                <c:forEach items="${systemHotList}" var="systemHot" varStatus="status">
                    <tr class="tableInfo">
                        ...
                        <td class="pic">
                            <c:if test="${systemHot.noticeUrl != '1'}">
                                <img src="${systemHot.noticeUrlFormat }"/>
                            </c:if>
                            <c:if test="${systemHot.noticeUrl == '1'}">
                        ...
                        <td class="operate">
                            ...
                            <c:if test="${backer_rolePower['114005'] == 114005}">
                                <a href="<%=path %>/backerWeb/hotTopic/hotTopicDetails.htm/${systemHot.id }" class="details">详&nbsp;情</a>
                            </c:if>
