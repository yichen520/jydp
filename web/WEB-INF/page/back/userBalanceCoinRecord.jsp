...
<div class="content">
    ...
    <div class="contentRight">
        ...
        <div class="top">
            <div class="askArea">
                <form id="queryForm" action="<%=path %>/backerWeb/backerHandleUserBalanceMoney/show.htm" method="post">
                    <p class="condition">
                        操作时间：
        ...
        <div class="bottom">
            <table class="table" cellspacing="0" cellpadding="0">
                ...
                <c:forEach items="${backerHandleUserBalanceMoneyList}" var="item">
                    <tr class="tableInfo">
                        ...
                        <td class="money"><fmt:formatNumber type="number" value="${itemuserBalance }" maxFractionDigits="2"/></td>
