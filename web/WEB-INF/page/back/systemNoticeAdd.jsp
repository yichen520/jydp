...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path %>/resources/css/back/noticeAdd.css" />
...
<div class="content">
    ...
    <div class="contentRight">
        <div class="caption">
            <span class="title">新增公告</span>
        </div>

        <div class="bottom">
            <form id="addForm" action="<%=path%>/backerWeb/backerNotice/addNotice.htm" enctype="multipart/form-data" method="post">
                <div class="addInfo">
                    <p class="condition">
                        公告类型<span class="star">*</span>：<input type="text" class="askInput" placeholder="公告类型，2~16个字符" maxlength="16" id="noticeType" name="noticeType"/>
                    </p>
                    <p class="condition">
                        公告标题<span class="star">*</span>：<input type="text" class="askInput" placeholder="公告标题，2~32个字符" maxlength="32" id="noticeTitle" name="noticeTitle"/>
                    </p>
                    <p class="condition">
                        封面图：
                        <span class="pic">
...
<script type="text/javascript">
    ...
    function addHandle() {
        ...
        $.ajax({
            url: '<%=path %>' + "/backerWeb/backerNotice/addNotice.htm",
            data:formData,//参数
            dataType: "json",
            type: 'POST',
