...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path %>/resources/css/back/accountRole_add.css" />
    ...
    function roleSubmit() {
        ...
        Object.keys(inputList).map(function executeHandle(num) {
            ...
            if (itemInput.type == "checkbox" && itemInput.checked) {
                ...
                var mainId = parseInt(powerId/10000)*10000;
                powerIdList += powerId + ":" + powerId + ",";
                mainPowerList += mainId + ":" + mainId + ",";
            }
        });
        //二级，三级权限
        ...
        if (!roleName || roleName.length<2 || roleName.length>10) {
        ...
        $("#add_powerJson").val(powerJson);
        $("#add_mainPowerJson").val(mainPowerJson);
        $("#addForm").submit();
    }
</script>
<script type="text/javascript">
