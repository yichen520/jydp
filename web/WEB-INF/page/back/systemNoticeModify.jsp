...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path %>/resources/css/back/noticeChange.css" />
...
<div class="content">
    ...
    <div class="contentRight">
        <div class="caption">
            <span class="title">修改公告</span>
        </div>

        <div class="bottom">
            <form id="modifyForm" action="<%=path%>/backerWeb/backerNotice/modifyNotice.htm" enctype="multipart/form-data" method="post">
                <div class="addInfo">
                    <p class="condition">
                        公告类型<span class="star">*</span>：<input type="text" class="askInput" placeholder="公告类型，2~16个字符" value="${systemNoticeDO.noticeType }" maxlength="16" id="noticeType" name="noticeType"/>
                    </p>
                    <p class="condition">
                        公告标题<span class="star">*</span>：<input type="text" class="askInput" placeholder="公告标题，2~32个字符" value="${systemNoticeDO.noticeTitle }" maxlength="32" id="noticeTitle" name="noticeTitle"/>
                    </p>
                    <p class="condition">
                        封面图：
                        <span class="pic">
                    ...
                    <div class="editor">
                        <script id="editor" type="text/plain">${systemNoticeDO.content }</script>
                    </div>

                    <input type="hidden" id="content" name="content"/>
                    <input type="hidden" id="id" name="id" value="${systemNoticeDO.id }"/>
...
<form id="openListForm" action="<%=path %>/backerWeb/backerNotice/show.htm" method="post">
...
<script type="text/javascript">
    ...
    function modifyHandle() {
        ...
        $.ajax({
            url: '<%=path %>' + "/backerWeb/backerNotice/modifyNotice.htm",
            data:formData,//参数
            dataType: "json",
            type: 'POST',
