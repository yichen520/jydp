...
public class BackerHandleUserBalanceFreezeMoneyServiceImpl implements IBackerHandleUserBalanceFreezeMoneyService {
    ...
    public List<BackerHandleUserBalanceFreezeMoneyVO> getUserRecordBalanceList(String userAccount, int typeHandle, int currencyId, String backerAccount,
        ...
        return backerHandleUserBalanceFreezeMoneyDao.getUserRecordBalanceList(userAccount, typeHandle, currencyId, backerAccount, startAddTime, endAddTime,
                pageNumber, pageSize);
    }
    ...
    public int getUserRecordBalanceNumber(String userAccount, int typeHandle, int currencyId, String backerAccount,
        ...
        return backerHandleUserBalanceFreezeMoneyDao.getUserRecordBalanceNumber(userAccount, typeHandle, currencyId, backerAccount, startAddTime, endAddTime);
    }
}
