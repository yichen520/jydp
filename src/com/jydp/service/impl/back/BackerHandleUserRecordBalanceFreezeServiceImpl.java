...
public class BackerHandleUserRecordBalanceFreezeServiceImpl implements IBackerHandleUserRecordBalanceFreezeService {
    ...
    public List<BackerHandleUserRecordBalanceFreezeDO> getUserRecordBalanceFreezeList(String userAccount, int typeHandle, String backerAccount,
        ...
        return backerHandleUserRecordBalanceFreezeDao.getUserRecordBalanceFreezeList(userAccount, typeHandle, backerAccount, startAddTime, endAddTime,
                pageNumber, pageSize);
    }
    ...
    public int getUserRecordBalanceFreezeNumber(String userAccount, int typeHandle, String backerAccount,
        ...
        return backerHandleUserRecordBalanceFreezeDao.getUserRecordBalanceFreezeNumber(userAccount, typeHandle, backerAccount, startAddTime, endAddTime);
    }
}
