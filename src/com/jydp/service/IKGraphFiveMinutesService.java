 ...
 * @author whx
 */
public interface IKGraphFiveMinutesService {
     ...
     */
    boolean insertKGraph(List<KGraphFiveMinutesDO> kGraphFiveMinutesList);
     ...
     */
    KGraphFiveMinutesDO getKGraphLately(int currencyId);
     ...
     */
    List<KGraphFiveMinutesDO> listKGraphLately(int currencyId, int num);
